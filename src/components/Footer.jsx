    ...
    <>
      <div className="text-gray-200 bg-primary_2 pt-10">
        <div className="grid grid-flow-col gap-8 lg:gap-28 mx-[10vw] pb-10">
          <div>
            <div className="text-primary_1 text-lg font-extralight text-start pb-2 border-b-2 border-b-red-600">CONTACT</div>
            <div className="grid grid-flow-row gap-2 justify-start mt-2">
          ...
          <div>
            <div className="text-primary_1 text-lg font-extralight pb-2 border-b-2 border-b-red-600">SERVICE HOURS</div>
            <div className="grid grid-flow-row gap-2 items-center mt-2">
              <span><b>Store Hours</b>: 10 A.M - 10 P.M</span>
              <span><b>Online Store</b>: 24-hour Support</span>
            </div>
          </div>
          <div>
            <div className="text-primary_1 text-lg font-extralight pb-2 border-b-2 border-b-red-600">HELP</div>
            <div className="grid grid-flow-row gap-2 mt-2">
              ...
              <span className="text-red-600 cursor-pointer">Scheddule a Repair</span>
            </div>
          </div>
        </div>
        <div className="bg-gray-900">
          <div className="text-gray-400 flex py-1 mx-[10vw]">
            ...
            <span className="ml-1">2023 Microware, Inc. All Rights Reserved</span>
          </div>
        </div>
      </div>
    </>
