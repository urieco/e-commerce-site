        ...
        >
          ...
          <label className="group relative">
            <input
              ...
              id="registerBtn"
              value="REGISTER"
              className="text-gray-200 bg-primary_1 group-hover:bg-red-500 text-2xl font-semibold w-[105vw] sm:w-[23rem] absolute top-3 right-[-2.5rem] py-3 rounded-md mt-4 cursor-pointer z-10 select-none"
            />
