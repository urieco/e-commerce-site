...
import { FormField } from "../../components/login&Registration/subcomponents/FormField";

import { addUser } from "../../utils/connectToCloud";
        ...
        >
          ...
          <label className="group relative">
            <input
              ...
              id="registerBtn"
              value="REGISTER"
              className="text-gray-200 bg-primary_1 group-hover:bg-red-500 text-2xl font-semibold w-[105vw] sm:w-[22.75rem] absolute top-3 -right-[-2.5rem] py-3 rounded-md mt-4 cursor-pointer z-10 select-none"
            />
            ...
            <div className="relative bottom-[-3.3rem] right-10 sm:right-[-19.75rem] w-0 h-0 border-solid border-t-transparent border-b-transparent border-y-[10px] border-r-red-800 group-hover:border-r-red-600 border-r-[10px] rotate-180 z-0"></div>
          </label>
        </form>
